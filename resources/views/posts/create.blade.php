  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-2 me-5">
            <div class="d-flex flex-column flex-shrink-0 bg-light shadow" style=" width: 270px">
                <div class="d-flex flex-column flex-shrink-0 bg-light mt-4" style="width: 250px; height:1000vh">
                    <a href="../posts" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
          ...
          <div class="col-9">
            <!-- FORM -->
            <form action="{{url("posts")}}" method="post" class="form-control mt-4">
                <h2>Form Request Meeting</h2>
                @csrf
                <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="floatingInput" placeholder="Tanggal" name="tanggal" required>
                    <label for="floatingInput">Tanggal</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="time" class="form-control" id="floatingPassword" placeholder="jam" name="jam" required>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="aplikasi" name="aplikasi" required>
                    <label for="floatingPassword">aplikasi</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="agenda" name="agenda" required>
                    <label for="floatingPassword">agenda</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="reqby" name="reqby" required>
                    <label for="floatingPassword">Request by</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="link" name="link" value="Wait From IT" disabled>
                    <label for="floatingPassword">link</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="detail" name="detail" value="Wait From IT" disabled>
