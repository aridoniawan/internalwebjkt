  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="d-flex flex-column flex-shrink-0 bg-light shadow" style=" width: 270px">
                <div class="d-flex flex-column flex-shrink-0 bg-light mt-4" style="width: 250px; height:1000vh">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto ms-4">
                      ...
                      <li>
                        <a href="{{url("kosts")}}" class="nav-link link-dark">                         
                          Request Vicon
                        </a>
                      </li>
                      <li>
          ...
          <div class="col-9">
            <!-- FORM -->
            <form action="{{url("kosts/$kost->id")}}" method="post" class="form-control mt-4">
                @method('PATCH')
                @csrf
                <h2>Form Request Meeting</h2>
                <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="floatingInput" placeholder="Tanggal" name="tanggal" value="{{$kost->tanggal}}" required>
                    <label for="floatingInput">Tanggal</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="time" class="form-control" id="floatingPassword" placeholder="jam" name="jam" value="{{$kost->jam}}" required>
                    <label for="floatingPassword">jam</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingPassword" placeholder="email" name="email" value="{{$kost->email}}" required>
                    <label for="floatingPassword">Email</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="aplikasi" name="aplikasi" value="{{$kost->aplikasi}}" required>
                    <label for="floatingPassword">aplikasi</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="agenda" name="agenda" value="{{$kost->agenda}}" required>
                    <label for="floatingPassword">agenda</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="reqby" name="reqby" value="{{$kost->reqby}}" required>
                    <label for="floatingPassword">Request by</label>
                  </div>
                  <div class="form-floating mb-3">
                    <textarea class="form-control" id="content" rows="3" name="detail">{{$kost->detail}}</textarea>
                    <label for="content">Detail </label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="link" name="link" value="{{$kost->link}}" required>
                    <label for="floatingPassword">link</label>
                  </div>
                  <div class="form-floating mb-3">
                    <select name="rmeeting" class="form-select" aria-label="Default select example" required>
                      <option selected>{{$kost->rmeeting}}</option>
